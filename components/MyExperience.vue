...
<template>
  <div>
    <h2 class="font-bold md:text-4xl text-2xl dark:text-white">Experiences</h2>

    <article class="mt-8 flex flex-col gap-4 text-lg">
      <MyTimeline :elements="experiences"></MyTimeline>
    </article>
  </div>
</template>
